...
import { FormLabel as FormLabel$1, useColorModeValue, FormControl, Spinner, Flex, Icon } from '@chakra-ui/react';
...
var FormLabel = function FormLabel(_ref) {
  ...
  return React.createElement(FormLabel$1, Object.assign({
    htmlFor: name,
    fontSize: "0.84rem",
    width: "100%",
    mb: "6px"
...
var Select = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var themeBgControl = useColorModeValue('#ffffff', 'inherit');
  var themeColorSingleValue = useColorModeValue('#000000', '#ffffff');
  var themeControlBorderColor = useColorModeValue('#E2E8F0', 'rgba(255, 255, 255, 0.16)');
  var themeControlBorderColorFocused = useColorModeValue('#3182ce', '#63b3ed');
  var themeControlBoxShadowFocused = useColorModeValue('0 0 0 1px #3182ce', '0 0 0 1px #63b3ed');
  var themeControlBorderColorHoverFocused = useColorModeValue('#3182ce', '#63b3ed');
  var themeControlBorderColorHover = useColorModeValue('#CBD5E0', 'rgba(255, 255, 255, 0.24)');
  var themeBgMenuList = useColorModeValue('#ffffff', '#2D3748');
  var themeBgOptionSelected = useColorModeValue('#3182ce', '#90cdf4');
  var themeBgOptionHoverSelected = useColorModeValue('#3182ce', '#90cdf4');
  var themeBgOptionHover = useColorModeValue('#EDF2F6', 'rgba(255, 255, 255, 0.06)');
  var themeColorOptionActiveSelected = useColorModeValue('#000000', '#000000');
  var themeColorOptionActive = useColorModeValue('#3182ce', 'rgba(255, 255, 255, 0.80)');
  var themeColorOption = useColorModeValue('#ffffff', '#000000');
  var themeColorOptionSelected = useColorModeValue('#000000', '#ffffff');
  var themePlaceholderColor = useColorModeValue('#A0AEC0', 'rgba(255, 255, 255, 0.24)');
  var themeColorNoOptionsMessage = useColorModeValue('#A0AEC0', 'rgba(255, 255, 255, 0.24)');
  var themeBgMultiValue = useColorModeValue('#EDF2F7', '#2D3748');
  var themeColorMultiValueLabel = useColorModeValue('#000000', '#fffff');
  var themeColorInput = useColorModeValue('#000000', '#ffffff');
  var themeColorInvalid = useColorModeValue('#e53e3e', '#FC8181');
  var themeShadowInvalid = useColorModeValue('0 0 0 1px #e53e3e', '0 0 0 1px #FC8181');
  ...
  var DropdownIndicator = function DropdownIndicator(_ref3) {
    ...
    return React.createElement(Flex, Object.assign({
      alignItems: "center",
      alignContent: "center"
    }, innerProps), React.createElement(Icon, {
      as: ChevronDownIcon,
      fontSize: "1.5rem"
    }));
  };
...
export { Select };
//# sourceMappingURL=chakra-lib.esm.js.map
